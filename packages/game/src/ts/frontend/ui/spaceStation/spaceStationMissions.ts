...
export function generateMissionsDom(
    ...
    const neighborSystems = getNeighborStarSystemCoordinates(starSystem.coordinates, 75, universeBackend);
    ...
    for (const neighbor of neighborSystems) {
        const systemModel = universeBackend.getSystemModelFromCoordinates(neighbor.coordinates);
        if (systemModel === null) {
